...
- **Functionality**  
  It is more modular, upgradeable, efficient, stable, better commented, and in my opinion, more intuitive.  
  Given its relatively newness, it doesn't yet have some of the functionality of the first, and its error catching is less than stellar.
  ...
  and is more than likely the only one that will continue receiving support and improvements into the future.
...
- **Thoughts and Influences**  
  ...
  as well as inspiration from pytorch.  
